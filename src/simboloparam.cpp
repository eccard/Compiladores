...
int SimboloParam::getPosicao() { return this->posicao; }
void SimboloParam::setPosicao(int posicao) { this->posicao = posicao; }
void SimboloParam::print() {
  std::cout << this->getNome() << " " << this->getScopo() << " "
            << this->getClasse() << " " << this->getTipo() << " "
            << this->getPosicao() << std::endl;
}
